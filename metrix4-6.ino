...
#define CLK_PIN3  21  // 클록 핀
#define CS_PIN9 20  // 아홉 번째 모듈의 칩 선택 핀
#define CS_PIN10 19   // 열 번째 모듈의 칩 선택 핀
#define CS_PIN11 18   // 열한 번째 모듈의 칩 선택 핀
#define CS_PIN12 17   // 열두 번째 모듈의 칩 선택 핀
